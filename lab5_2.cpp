...
public:
	void push(const double& i) {
	 ...
	 double pop() {
		...
		std::cout << "Zajetosc: " << T::zajetosc() << std::endl;
		double i = T::pop();
		std::cout << "Zdjeto: " << i <<"\n";
		return i;
	}
...
public:
	...
	double pop() {
		double i = 1;
		//std::cout << "Zdjeto: " << T::pop() << std::endl;
		suma = suma - T::pop();
		std::cout << "Suma: " <<  suma << "\n";
		return suma;
	}
...
int main() {
	...
	//system("pause");
	//system("cls");
	cout << "2 zadanie labolatoryjne"<< "\n";
	system("pause");

	Stos2 K1;
	DomieszkaJeden< Stos2> K2;
	K2.push(7);
	K2.push(7);
	K2.push(7.1);
	K2.push(7.5);
